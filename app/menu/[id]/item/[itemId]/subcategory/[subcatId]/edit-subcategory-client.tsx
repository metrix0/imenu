...
export default function EditSubcategoryClient({
    ...
    function goAddSubitem() {
        router.push(`/menu/${menuId}/item/${itemId}/subcategory/${subcategory.id}/add-subitem`);
    }
        ...
        <div className="p-6">
            ...
            <form onSubmit={handleSave} className="bg-white p-6 rounded shadow border max-w-2xl mb-6">
                ...
                <div className="flex gap-3">
                    ...
                    <button type="button" onClick={() => router.push(`/menu/${menuId}/item/${itemId}`)} className="px-3 py-2 rounded border">Voltar</button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {localSubitems.map(si => (
                            <div
                                ...
                                onClick={() => router.push(`/menu/${menuId}/item/${itemId}/subcategory/${subcategory.id}/edit-subitem/${si.id}`)}
                            >
                                <div>
