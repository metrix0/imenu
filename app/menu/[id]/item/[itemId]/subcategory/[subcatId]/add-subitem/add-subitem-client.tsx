...
export default function AddSubitemClient({ menuId, itemId, subcatId }: { menuId: string; itemId: string; subcatId: string; }) {
    ...
    async function handleSave(e?: React.FormEvent) {
        ...
        try {
            ...
            router.push(`/menu/${menuId}/item/${itemId}/subcategory/${subcatId}`);
        } finally {
            setSaving(false);
        }
    }
        ...
        <div className="p-6 max-w-2xl">
            ...
            <form onSubmit={handleSave} className="bg-white p-6 rounded shadow border">
                ...
                <div className="flex gap-3">
                    ...
                    <button type="button" onClick={() => router.push(`/menu/${menuId}/item/${itemId}/subcategory/${subcatId}`)} className="px-3 py-2 rounded border">Cancelar</button>
                </div>
            </form>
        </div>
    );
