        ...
        <div className="max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <aside className="space-y-4 h-[calc(100vh-6rem)] overflow-auto">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        onClick={() => router.push(`/menu/${menuId}/item/${item.id}/add-subcategory`)}
                ...
                {subcategories.length === 0 ? (
                    ...
                    subcategories.map((sc) => (
                        ...
                        <div
                            ...
                            onClick={() => router.push(`/menu/${menuId}/item/${item.id}/subcategory/${sc.id}`)}
                        >
                            ...
                            <div className="mt-3 grid grid-cols-3 gap-2">
                                {(sc.subitems || []).slice(0, 6).map(si => (
                                    <div
                                        ...
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            router.push(`/menu/${menuId}/item/${item.id}/subcategory/${sc.id}/edit-subitem/${si.id}`);
                                        }}
                                    >
                                        {si.image_path ? (
                                ...
                                <button
                                    onClick={(e) => { e.stopPropagation(); router.push(`/menu/${menuId}/item/${item.id}/subcategory/${sc.id}/add-subitem`); }}
