...
export default function PanelClient({ menuName, orders, orderItems }: any) {
                    ...
                    return (
                        ...
                        >
                            ...
                            <p className="text-sm text-gray-500">
                                Criado: {formattedDates[order.id] ?? "..."}
                            </p>
                            ...
                            <p className="mt-3 font-semibold">
                                Total: R$ {(order.total_cents / 100).toFixed(2)}
                            </p>
