...
export default function CriarCardapioPage() {
    ...
    const responsiblePhoneInvalid=needsResponsiblePhone&&responsiblePhone.replace(/\D/g,"").length!==11;
    const finishVisuallyBlocked=!name.trim()||profileStatus==="error"||responsiblePhoneInvalid;
    ...
    return <main className="flex min-h-screen flex-col items-center bg-white px-4 pb-32 pt-4 sm:px-6"><div className="mt-4 w-full max-w-4xl"><div className="panel-essencial mb-8 text-center sm:text-left"><p className="mb-2 text-xs font-bold uppercase tracking-[0.18em] text-brand">Etapa 4/4</p><h1 className="text-3xl font-bold text-gray-900">Defina sua Loja</h1><p className="mt-1 text-gray-500">Adicione sua marca e seus primeiros produtos.</p></div>
