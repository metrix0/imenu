...
export default function AddSubcategoryClient({
    ...
    function goAddSubitem() {
        if (!restauranteId || !menuId || !itemId || !createdId) {
            router.push(`/painel/${restauranteId}/cardapio/${menuId}/item/${itemId}`);
            return;
        }
        router.push(`/painel/${restauranteId}/cardapio/${menuId}/item/${itemId}/subcategory/${createdId}/add-subitem`);
    }
        ...
        <div className="p-6 max-w-3xl">
            ...
            <form onSubmit={handleSave} className="bg-white p-6 rounded shadow border">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        type="button"
                        onClick={() => router.push(`/painel/${restauranteId}/cardapio/${menuId}/item/${itemId}`)}
