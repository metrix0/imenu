...
export default function PainelLayout({
    ...
    if(window.innerWidth < 768){
        return(
            <div
                className="fixed inset-0 z-[9999] flex items-center justify-center bg-white text-black px-6 text-center
        ...
        return (
            ...
            <div className="flex min-h-screen bg-gray-50">
                ...
                {/* === MAIN CONTENT === */}
                <main className={`flex-1 p-8 ${expanded ? "ml-60" : "ml-15" } duration-300`}>{children}</main>
            </div>
        );
    }
