...
export default function LandingPage() {
    ...
    return (
        <div className="w-full max-w-screen overflow-x-clip">
            ...
            <header className="flex w-full flex-col items-center justify-between gap-4 border-gray-200 bg-white px-8 py-7 md:flex-row md:gap-0 md:py-5 min-[1400px]:px-12 min-[1400px]:py-6 2xl:px-16 2xl:py-8">
                <div className="flex items-center gap-2 text-xl font-bold text-brand">
                    <Image
                        ...
                        width={200}
                        height={42}
                        className="ml-4 h-6 w-auto cursor-pointer min-[1400px]:ml-6 min-[1400px]:h-8 2xl:ml-8 2xl:h-10"
                        onClick={() => router.push("#")}
                    />
                </div>
                ...
                <nav className="z-30 flex items-center gap-8 text-sm font-medium md:z-auto min-[1400px]:gap-10 min-[1400px]:text-base 2xl:gap-11 2xl:text-[1.2rem]">
                    ...
                    {restCount > 0 && (
                        <Tooltip
                            ...
                            size="medium"
                            padding="p-4 min-[1400px]:p-5 2xl:p-6"
                            position="bottom"
                        >
                            <BonusButton>
                                <span className="inline-block">
                                    <span className="text-[0.8rem] min-[1400px]:text-[0.95rem] 2xl:text-[1.1rem]">
                                        BÔNUS
                                    </span>{" "}
            ...
            <section className="relative mx-auto grid h-full grid-cols-1 gap-10 px-6 py-0 text-center md:h-[89svh] md:grid-cols-2 md:px-15 md:py-20 md:text-left min-[1400px]:gap-14 min-[1400px]:px-20 2xl:max-w-[1920px] 2xl:px-24">
                ...
                <div className="flex items-center justify-center">
                    <div className="absolute top-0 hidden h-full w-100 overflow-hidden md:block min-[1400px]:w-112 2xl:w-128">
                        <video
                            src="/images/CellphoneVideo.webm"
                            autoPlay
                            loop
            ...
            <section className="mx-auto h-auto max-w-[1920px] px-8 py-16 md:min-h-[100vh] min-[1400px]:py-20 2xl:py-26">
                ...
                <div className="flex flex-col gap-4 md:mx-18 md:flex-row md:gap-12 min-[1400px]:mx-24 min-[1400px]:gap-14 2xl:mx-28">
                    <div className="flex h-auto flex-1 flex-col items-center gap-8 md:flex-row md:items-start md:gap-10 min-[1400px]:gap-12 2xl:gap-16">
                        <div
                            id="logos"
                            className="reveal fade-up flex h-full flex-row items-center justify-center gap-5 pt-4 md:flex-col min-[1400px]:gap-6 2xl:gap-8"
                        >
                            {LOGOS.map((logo) => (
                                <button
                                    key={logo.id}
                                ...
                                >
                                    <span className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-full bg-gray-200 duration-200 hover:scale-110 min-[1400px]:h-16 min-[1400px]:w-16 2xl:h-20 2xl:w-20">
                                        <Image
                                            src={logo.src}
                                            alt={logo.name}
                                            width={80}
                        ...
                        <div className="delay-300 md:reveal md:fade-right relative z-50 flex h-full flex-1 flex-col gap-8 md:flex-row min-[1400px]:gap-10 2xl:gap-12">
                            <div className="w-full md:w-[45%] min-[1400px]:w-[47%] 2xl:w-[50%]">
                                <div className="relative mx-auto aspect-[9/16] h-full max-h-[65svh] w-full max-w-sm overflow-hidden min-[1400px]:max-h-[68svh]">
                                    <div
                                        key={selected}
                            ...
                            <div className="z-40 mt-4 ml-0 flex w-full flex-col justify-center gap-8 text-center md:mt-0 md:ml-3 md:w-[43%] md:text-left min-[1400px]:gap-10 2xl:gap-12">
                                <div>
                                    <h3 className="mb-1 text-lg font-bold min-[1400px]:text-xl 2xl:text-[1.5rem]">
                                        Venda sem taxas
                                    </h3>
                                    <p className="text-gray-500 min-[1400px]:text-lg 2xl:text-xl">
                                ...
                                <div>
                                    ...
                                    <div className="z-50 text-gray-500 min-[1400px]:text-lg 2xl:text-xl">
                                        A{" "}
                                        <Tooltip
                    ...
                    <div className="relative z-1 mt-10 flex flex-1 items-center justify-center md:mt-0 md:h-[63svh] min-[1400px]:h-[66svh]">
                        <div className="reveal fade-left delay-500 relative z-1 h-full w-full">
                            <Image
                                ...
                                width={1080}
                                height={1920}
                                className="z-1 mt-0 ml-0 h-[105%] w-auto md:-mt-5 md:ml-7 min-[1400px]:ml-10 2xl:-mt-10 2xl:ml-20"
                            />
                        </div>
                    </div>
                </div>
            ...
            >
                ...
                <h2 className="reveal fade-left delay-200 mb-12 text-center text-gray-500 md:mb-18 md:text-left min-[1400px]:mb-20 min-[1400px]:text-lg 2xl:mb-24 2xl:text-xl">
                    Compare os benefícios entre o iMenu e outros cardápios digitais:
                </h2>

                <div className="overflow-x-auto">
                    <table className="m-auto w-auto min-w-[620px] border-collapse overflow-hidden rounded-sm md:w-[80%] min-[1400px]:text-lg 2xl:rounded-lg 2xl:text-[1.4rem]">
                        <thead className="border-b border-gray-200 text-left">
                            <tr className="bg-gray-100">
                                <th className="border-r border-gray-200 p-4 font-medium min-[1400px]:p-5 2xl:p-6">
                                    Recursos
                                </th>
                                <th className="border-r border-gray-200 p-4 font-medium min-[1400px]:p-5 2xl:p-6">
                                    <img
                                        ...
                                        alt="iMenu"
                                        className="w-18 opacity-70 min-[1400px]:w-20 2xl:w-24"
                                    />
                                </th>
            ...
            <section className="relative mx-6 mt-20 md:mx-24 min-[1400px]:mx-28 min-[1400px]:mt-24 2xl:mx-38">
                ...
                <div className="relative isolate overflow-hidden rounded-[2rem] border border-orange-300/60 bg-gradient-to-br from-[#ff7424] via-brand to-dark-brand px-6 py-14 text-center text-white shadow-[0_34px_90px_-34px_rgba(201,63,11,0.9)] md:px-12 md:py-18 min-[1400px]:px-16 min-[1400px]:py-20 2xl:py-24">
                    ...
                    <div className="relative mx-auto max-w-4xl">
                        ...
                        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-white/85 md:text-lg min-[1400px]:max-w-3xl min-[1400px]:text-xl min-[1400px]:leading-8 2xl:text-2xl 2xl:leading-9">
