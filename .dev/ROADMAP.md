...
| Handle All Payments without Link + Refunds System            |        | iFood                | handle all payments on website only (no webhook, no other pages) using API.                                                                                                                                                                                                                |
...
| ★ Cupom de desconto E PROMOCAO                               | ✅ João | iFood                | %, R$ fixo, MTO COMPLEXO VER IFOOD. -> Afeta o cardápio que o usuáriu vê (igual no ifood), afeta a compra final e talvez ainda tem que colocar explicado em cada pedido que o usuário usou um cupom                                                                                        |
|                                                              |        |                      |                                                                                                                                                                                                                                                                                            |
...
| ★ Instagram Bot                | Rafa  | igual      | Ig: Same thing (Meta Graph API)                                                                                                                                                |
...
| Videos and Multiple Images                           |       | (botão img)       | add videos + add compression to images vides eveerting thats uploaded and convert to webp is that ideal? (TANTO NO PAINEL QUANDO PRO CLIENTE)                                                        |
